...
namespace DACS_TimeManagement.Migrations
{
    ...
    [Migration("20260522071042_AddOtpRecord2FA")]
    partial class AddOtpRecord2FA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.GoalProgressHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.GoalTask", b =>
                {
                    b.Property<int>("GoalId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.OtpRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.PersonalGoal", b =>
                {
                    ...
                    b.Property<string>("AIActionPlanEn")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AIActionPlanVi")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.Project", b =>
                {
                    ...
                    b.Property<string>("AIStrategyEn")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AIStrategyVi")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.ScheduledEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.TaskChangeRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TaskChangeRequests");
                });

            modelBuilder.Entity("DACS_TimeManagement.Models.TaskHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("NewBoardListId")
                        .HasColumnType("int");

                    b.Property<int?>("OldBoardListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.TimeLog", b =>
                {
                    ...
                    b.Property<bool>("IsFocusSession")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.UserProfile", b =>
                {
                    ...
                    b.Property<DateTime?>("LastTaskCompletedDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.UserWorkSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<TimeOnly>("DefaultEndHour")
                        .HasColumnType("time");

                    b.Property<TimeOnly>("DefaultStartHour")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.GoalProgressHistory", b =>
                {
                    b.HasOne("DACS_TimeManagement.Models.PersonalGoal", "Goal")
            ...
            modelBuilder.Entity("DACS_TimeManagement.Models.ScheduledEvent", b =>
                {
                    b.HasOne("DACS_TimeManagement.Models.WorkTask", "Task")
